...
describe DeliveryAddress do
  describe '#create' do
    ...
    it "is invalid without a delivery_first_name" do
      ...
      delivery_address.valid?
      expect(delivery_address.errors[:delivery_first_name]).to include("can't be blank")
    end
    ...
    it "is invalid without a delivery_first_name_kana" do
      ...
      delivery_address.valid?
      expect(delivery_address.errors[:delivery_first_name_kana]).to include("can't be blank")
    end
    ...
    it "is invalid without a post_code" do
      ...
      delivery_address.valid?
      expect(delivery_address.errors[:post_code]).to include("can't be blank")
    end
    ...
    it "is invalid without a prefecture_id" do
      ...
      delivery_address.valid?
      expect(delivery_address.errors[:prefecture_id]).to include("can't be blank")
    end
    ...
    it "is invalid without a city" do
      ...
      delivery_address.valid?
      expect(delivery_address.errors[:city]).to include("can't be blank")
    end
    ...
    it "is invalid without a home_number" do
      ...
      delivery_address.valid?
      expect(delivery_address.errors[:home_number]).to include("can't be blank")
    end
    ...
    it "is invalid with a duplicate phone_number" do
      ...
      expect(another_delivery_address.errors[:phone_number]).to include("has already been taken")
    end
    ...
    it "is invalid with a post_code that has less than 7 characters " do
      ...
      delivery_address.valid?
      expect(delivery_address.errors[:post_code]).to include("is invalid")
    end
    ...
    it "delivery_first_name can only be full-width" do
      ...
      delivery_address.valid?
      expect(delivery_address.errors[:delivery_first_name]).to include("is invalid")
    end
